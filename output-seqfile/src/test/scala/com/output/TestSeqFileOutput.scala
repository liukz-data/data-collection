...
import java.io.{ByteArrayOutputStream, File, FileInputStream, FileReader, InputStreamReader}
import java.net.URI
import java.util
...
//        new GetMroObjFromFile(new InputStreamReader(new FileInputStream(dataFile._2))).getMroObj)
        ...
        new GetMroObjFromFile(new InputStreamReader(new FileInputStream(dataFile))).getMroObj)
      }
