...
object TestMroTable {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 3. 调用测试主程序
    MroTable.executeMerge(
//      Array(".\\conf\\mromerge-conf.properties"),
      ...
      Array("/test/test_lkz_other/prop/lkz-test-mromerge-conf-v5.properties"),
     // Array("/mro/property/mromerge-conf-hdfs.properties"),
      hadoopConfMap)
  }
